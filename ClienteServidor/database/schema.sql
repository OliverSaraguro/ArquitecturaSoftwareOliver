...
INSERT INTO products (name, description, price, stock) VALUES
    ('Whey Protein 2lb', 'Premium whey protein for muscle recovery.', 29.99, 20),
    ('Creatine Monohydrate', 'Micronized creatine for strength and performance.', 18.50, 35),
    ('Gym Gloves', 'Padded lifting gloves for comfort and safety.', 12.99, 15),
    ('Resistance Bands Set', 'Set of 5 bands with different resistance levels.', 22.00, 10),
    ('Sports Bottle 1L', 'BPA-Free durable water bottle.', 8.00, 50);
